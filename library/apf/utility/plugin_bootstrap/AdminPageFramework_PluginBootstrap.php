...
abstract class InCloudAdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('InCloudAdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new InCloudAdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
