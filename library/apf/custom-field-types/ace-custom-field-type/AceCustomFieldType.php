<?php
/**
 * InCloudAceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'InCloudAceCustomFieldType' ) ) :
class InCloudAceCustomFieldType extends InCloudAdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.InCloud-field' ).nextAll().andSelf().each( function( iIndex ) {
    ...
    public function getField( $aField ) {
        ...
        return
            $aField['before_label']
            . "<div class='InCloud-input-label-container'>"
