 ...
 * @package     InCloudAdminPageFramework
 */

if ( ! class_exists( 'InCloudSelect2CustomFieldType' ) ) :
/**
 ...
 */
class InCloudSelect2CustomFieldType extends InCloudAdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.InCloud-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.InCloud-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.InCloud-select-label' )
                .children( 'label' )
                .children( '.InCloud-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set initial values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.InCloud-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.InCloud-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    jQuery().registerInCloudAdminPageFrameworkCallbacks( {
        /**
    ...
    protected function getStyles() {
        return "
.InCloud-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.InCloud-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .InCloud-field-select2 > .InCloud-select-label > label > .InCloud-input-container {
    max-width: 84%;
}
