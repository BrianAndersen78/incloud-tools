...
abstract class InCloudAdminPageFramework_Router extends InCloudAdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'InCloud') {
        $_sPropertyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'InCloudAdminPageFramework_Property_' . $this->_sStructureType;
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new InCloudAdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
    ...
    abstract class InCloudAdminPageFramework_Model_Form extends InCloudAdminPageFramework_Router {
        public $aFieldErrors;
        ...
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'InCloud') {
            ...
            new InCloudAdminPageFramework_Model__FormEmailHandler($this);
        ...
        public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            new InCloudAdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
        }
    ...
    abstract class InCloudAdminPageFramework_View_Form extends InCloudAdminPageFramework_Model_Form {
    ...
    abstract class InCloudAdminPageFramework_Controller_Form extends InCloudAdminPageFramework_View_Form {
        ...
        public function getValue() {
            ...
            return InCloudAdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
        }
    ...
    abstract class InCloudAdminPageFramework_Model_Page extends InCloudAdminPageFramework_Controller_Form {
        public function _replyToFinalizeInPageTabs() {
            ...
            foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
                ...
                $_oFormatter = new InCloudAdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
    ...
    abstract class InCloudAdminPageFramework_View_Page extends InCloudAdminPageFramework_Model_Page {
        public function _replyToEnablePageMetaBoxes() {
            new InCloudAdminPageFramework_View__PageMetaboxEnabler($this);
        }
        public function _replyToEnqueuePageAssets() {
            new InCloudAdminPageFramework_View__Resource($this);
        }
        ...
        protected function _renderPage($sPageSlug, $sTabSlug = null) {
            $_oPageRenderer = new InCloudAdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
            $_oPageRenderer->render();
        }
    }
    abstract class InCloudAdminPageFramework_Controller_Page extends InCloudAdminPageFramework_View_Page {
    ...
    abstract class InCloudAdminPageFramework_Model_Menu extends InCloudAdminPageFramework_Controller_Page {
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'InCloud') {
            parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
            new InCloudAdminPageFramework_Model_Menu__RegisterMenu($this);
        }
    }
    abstract class InCloudAdminPageFramework_View_Menu extends InCloudAdminPageFramework_Model_Menu {
    }
    abstract class InCloudAdminPageFramework_Controller_Menu extends InCloudAdminPageFramework_View_Menu {
        ...
        public function addSubMenuLink(array $aSubMenuLink) {
            ...
            $_oFormatter = new InCloudAdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
        ...
        public function addSubMenuPage(array $aSubMenuPage) {
            ...
            $_oFormatter = new InCloudAdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
            $_aSubMenuPage = $_oFormatter->get();
            $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
        }
    }
    abstract class InCloudAdminPageFramework_Model extends InCloudAdminPageFramework_Controller_Menu {
    }
    abstract class InCloudAdminPageFramework_View extends InCloudAdminPageFramework_Model {
        public function content($sContent) {
            return $sContent;
        }
    }
    abstract class InCloudAdminPageFramework_Controller extends InCloudAdminPageFramework_View {
        ...
        public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
            ...
            new InCloudAdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
        }
        ...
        static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
            return InCloudAdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
        }
    }
    abstract class InCloudAdminPageFramework extends InCloudAdminPageFramework_Controller {
        protected $_sStructureType = 'admin_page';
        public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'InCloud') {
        ...
        private function _getCallerPath($sCallerPath) {
            ...
            $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? InCloudAdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
