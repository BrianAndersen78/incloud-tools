...
abstract class InCloudAdminPageFramework_Model__FormSubmission_Base extends InCloudAdminPageFramework_Form_Utility {
    ...
    class InCloudAdminPageFramework_Model__FormSubmission extends InCloudAdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new InCloudAdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new InCloudAdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
