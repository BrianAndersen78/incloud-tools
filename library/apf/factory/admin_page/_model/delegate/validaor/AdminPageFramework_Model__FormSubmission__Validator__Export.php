...
class InCloudAdminPageFramework_Model__FormSubmission__Validator__Import extends InCloudAdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new InCloudAdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
    ...
    class InCloudAdminPageFramework_Model__FormSubmission__Validator__Export extends InCloudAdminPageFramework_Model__FormSubmission__Validator__Import {
        public $sActionHookPrefix = 'try_validation_after_';
        ...
        protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
            $_oExport = new InCloudAdminPageFramework_ExportOptions($_POST['__export'], $this->oFactory->oProp->sClassName);
