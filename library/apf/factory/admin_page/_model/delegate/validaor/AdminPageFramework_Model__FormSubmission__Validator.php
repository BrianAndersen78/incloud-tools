...
class InCloudAdminPageFramework_Model__FormSubmission__Validator_Base extends InCloudAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class InCloudAdminPageFramework_Model__FormSubmission__Validator extends InCloudAdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('InCloudAdminPageFramework_Model__FormSubmission__Validator__Link', 'InCloudAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'InCloudAdminPageFramework_Model__FormSubmission__Validator__Import', 'InCloudAdminPageFramework_Model__FormSubmission__Validator__Export', 'InCloudAdminPageFramework_Model__FormSubmission__Validator__Reset', 'InCloudAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'InCloudAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'InCloudAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new InCloudAdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
