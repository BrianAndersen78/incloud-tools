...
class InCloudAdminPageFramework_Format_SubMenuItem extends InCloudAdminPageFramework_Format_Base {
    ...
    public function get() {
        ...
        if (isset($_aSubMenuItem['page_slug'])) {
            $_oFormatter = new InCloudAdminPageFramework_Format_SubMenuPage($_aSubMenuItem, $this->oFactory, $this->iParsedIndex);
            return $_oFormatter->get();
        }
        if (isset($_aSubMenuItem['href'])) {
            $_oFormatter = new InCloudAdminPageFramework_Format_SubMenuLink($_aSubMenuItem, $this->oFactory, $this->iParsedIndex);
            return $_oFormatter->get();
        }
        return array();
    }
