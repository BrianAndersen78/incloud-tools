...
class InCloudAdminPageFramework_Property_admin_page extends InCloudAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'InCloud') {
        ...
        $GLOBALS['aInCloudAdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aInCloudAdminPageFramework', 'aPageClasses'));
        $GLOBALS['aInCloudAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
