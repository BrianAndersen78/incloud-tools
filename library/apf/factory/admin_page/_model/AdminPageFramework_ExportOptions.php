...
abstract class InCloudAdminPageFramework_CustomSubmitFields extends InCloudAdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
    ...
    class InCloudAdminPageFramework_ExportOptions extends InCloudAdminPageFramework_CustomSubmitFields {
        public $sClassName;
        public $sFileName;
        public $sFormatType;
        public $bIsDataSet;
            ...
            switch (strtolower($sFormatType)) {
                case 'text':
                    if (in_array(gettype($vData), array('array', 'object'))) {
                        echo InCloudAdminPageFramework_Debug::get($vData, null, false);
                    }
                    echo $vData;
                    return;
                case 'json':
