...
class InCloudAdminPageFramework_Form___SubmitNotice extends InCloudAdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new InCloudAdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new InCloudAdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
    }
