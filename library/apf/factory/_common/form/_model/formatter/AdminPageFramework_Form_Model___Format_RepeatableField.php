...
class InCloudAdminPageFramework_Form_Model___Format_RepeatableSection extends InCloudAdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : InCloudAdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class InCloudAdminPageFramework_Form_Model___Format_RepeatableField extends InCloudAdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
