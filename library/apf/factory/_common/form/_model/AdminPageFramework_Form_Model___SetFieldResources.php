...
class InCloudAdminPageFramework_Form_Model___SetFieldResources extends InCloudAdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new InCloudAdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('InCloudAdminPageFramework_Form_View___CSS_Form', 'InCloudAdminPageFramework_Form_View___CSS_Field', 'InCloudAdminPageFramework_Form_View___CSS_Section', 'InCloudAdminPageFramework_Form_View___CSS_CollapsibleSection', 'InCloudAdminPageFramework_Form_View___CSS_FieldError', 'InCloudAdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('InCloudAdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new InCloudAdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new InCloudAdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
