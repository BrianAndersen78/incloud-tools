...
class InCloudAdminPageFramework_Form_View___Description extends InCloudAdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'InCloud-form-element-description';
