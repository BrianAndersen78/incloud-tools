...
class InCloudAdminPageFramework_Form_View___Script_SectionTab extends InCloudAdminPageFramework_Form_View___Script_Base {
...
jQuery( '.InCloud-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='InCloud-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
