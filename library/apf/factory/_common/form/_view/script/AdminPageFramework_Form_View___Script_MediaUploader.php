...
class InCloudAdminPageFramework_Form_View___Script_MediaUploader extends InCloudAdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getInCloudAdminPageFrameworkCustomMediaUploaderSelectObject = function() {
