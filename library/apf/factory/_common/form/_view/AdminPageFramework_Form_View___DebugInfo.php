...
class InCloudAdminPageFramework_Form_View___DebugInfo extends InCloudAdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='InCloud-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
