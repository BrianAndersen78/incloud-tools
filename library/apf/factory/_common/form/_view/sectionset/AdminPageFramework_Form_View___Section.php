...
class InCloudAdminPageFramework_Form_View___Section extends InCloudAdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        $_oTableCaption = new InCloudAdminPageFramework_Form_View___SectionCaption($this->aSectionset, $_iSectionIndex, $this->aFieldsetsPerSection, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_oSectionTableAttributes = new InCloudAdminPageFramework_Form_View___Attribute_SectionTable($this->aSectionset);
        $_oSectionTableBodyAttributes = new InCloudAdminPageFramework_Form_View___Attribute_SectionTableBody($this->aSectionset);
        $_aOutput = array();
        ...
        $_oSectionTableContainerAttributes = new InCloudAdminPageFramework_Form_View___Attribute_SectionTableContainer($this->aSectionset);
    ...
    private function _getSectionContent($_iSectionIndex) {
        ...
        $_oFieldsets = new InCloudAdminPageFramework_Form_View___FieldsetRows($this->aFieldsetsPerSection, $_iSectionIndex, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        return $_oFieldsets->get();
    }
    private function _getCustomSectionContent() {
        if (is_scalar($this->aSectionset['content'])) {
            return "<tr class='InCloud-custom-content'>" . "<td>" . $this->aSectionset['content'] . "</td>" . "</tr>";
        }
        ...
        $_oFormTables = new InCloudAdminPageFramework_Form_View___Sectionsets($_aArguments, $_aStructure, $this->aSavedData, $this->aFieldErrors, $this->aCallbacks, $this->oMsg);
        return "<tr class='InCloud-nested-sectionsets'>" . "<td>" . $_oFormTables->get() . "</td>" . "</tr>";
    }
