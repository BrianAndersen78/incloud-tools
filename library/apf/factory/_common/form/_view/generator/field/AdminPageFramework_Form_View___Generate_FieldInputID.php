...
class InCloudAdminPageFramework_Form_View___Generate_FieldTagID extends InCloudAdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class InCloudAdminPageFramework_Form_View___Generate_FieldInputID extends InCloudAdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
