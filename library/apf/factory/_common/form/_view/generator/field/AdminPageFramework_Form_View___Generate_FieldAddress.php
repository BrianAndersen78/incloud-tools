...
abstract class InCloudAdminPageFramework_Form_View___Generate_Field_Base extends InCloudAdminPageFramework_Form_View___Generate_Section_Base {
    ...
    class InCloudAdminPageFramework_Form_View___Generate_FieldName extends InCloudAdminPageFramework_Form_View___Generate_Field_Base {
        public function get() {
    ...
    class InCloudAdminPageFramework_Form_View___Generate_FlatFieldName extends InCloudAdminPageFramework_Form_View___Generate_FieldName {
        public function get() {
    ...
    class InCloudAdminPageFramework_Form_View___Generate_FieldAddress extends InCloudAdminPageFramework_Form_View___Generate_FlatFieldName {
        public function get() {
