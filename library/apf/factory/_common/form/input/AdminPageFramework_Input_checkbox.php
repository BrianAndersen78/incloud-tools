...
abstract class InCloudAdminPageFramework_Input_Base extends InCloudAdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'InCloud-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'InCloud-input-label-string',),);
    ...
    class InCloudAdminPageFramework_Input_checkbox extends InCloudAdminPageFramework_Input_Base {
