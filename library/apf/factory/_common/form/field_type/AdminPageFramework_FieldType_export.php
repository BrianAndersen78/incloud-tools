...
class InCloudAdminPageFramework_FieldType_submit extends InCloudAdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".InCloud-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'InCloud-input-label-container' . ' InCloud-input-button-container' . ' InCloud-input-container',);
    }
    ...
    class InCloudAdminPageFramework_FieldType_export extends InCloudAdminPageFramework_FieldType_submit {
