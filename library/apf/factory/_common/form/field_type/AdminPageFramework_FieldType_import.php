...
class InCloudAdminPageFramework_FieldType_import extends InCloudAdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".InCloud-field-import input {margin-right: 0.5em;}.InCloud-field-import label,.form-table td fieldset.InCloud-fieldset .InCloud-field-import label { display: inline; }";
    }
