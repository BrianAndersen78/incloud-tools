...
abstract class InCloudAdminPageFramework_Property_Base extends InCloudAdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'InCloud' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aInCloudAdminPageFramework'])) {
            $GLOBALS['aInCloudAdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => InCloudAdminPageFramework_Registry::NAME, 'sURI' => InCloudAdminPageFramework_Registry::URI, 'sScriptName' => InCloudAdminPageFramework_Registry::NAME, 'sLibraryName' => InCloudAdminPageFramework_Registry::NAME, 'sLibraryURI' => InCloudAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => InCloudAdminPageFramework_Registry::getVersion(), 'sDescription' => InCloudAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => InCloudAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => InCloudAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => InCloudAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => InCloudAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new InCloudAdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
