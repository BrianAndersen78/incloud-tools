...
class InCloudAdminPageFramework_Message {
    ...
    protected $_sTextDomain = 'InCloud';
    static private $_aInstancesByTextDomain = array();
    public static function getInstance($sTextDomain = 'InCloud') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof InCloudAdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new InCloudAdminPageFramework_Message($sTextDomain);
        self::$_aInstancesByTextDomain[$sTextDomain] = $_oInstance;
        return self::$_aInstancesByTextDomain[$sTextDomain];
    }
    public static function instantiate($sTextDomain = 'InCloud') {
        return self::getInstance($sTextDomain);
    }
    public function __construct($sTextDomain = 'InCloud') {
    ...
    private function ___doDummy() {
        __('The options have been updated.', 'InCloud');
        __('The options have been cleared.', 'InCloud');
        __('Export', 'InCloud');
        __('Export Options', 'InCloud');
        __('Import', 'InCloud');
        __('Import Options', 'InCloud');
        __('Submit', 'InCloud');
        __('An error occurred while uploading the import file.', 'InCloud');
        __('The uploaded file type is not supported: %1$s', 'InCloud');
        __('Could not load the importing data.', 'InCloud');
        __('The uploaded file has been imported.', 'InCloud');
        __('No data could be imported.', 'InCloud');
        __('Upload Image', 'InCloud');
        __('Use This Image', 'InCloud');
        __('Insert from URL', 'InCloud');
        __('Are you sure you want to reset the options?', 'InCloud');
        __('Please confirm your action.', 'InCloud');
        __('The specified options have been deleted.', 'InCloud');
        __('A problem occurred while processing the form data. Please try again.', 'InCloud');
        __('Not all form fields could not be sent. Please check your server settings of PHP <code>max_input_vars</code> and consult the server administrator to increase the value. <code>max input vars</code>: %1$s. <code>$_POST</code> count: %2$s', 'InCloud');
        __('Is it okay to send the email?', 'InCloud');
        __('The email has been sent.', 'InCloud');
        __('The email has been scheduled.', 'InCloud');
        __('There was a problem sending the email', 'InCloud');
        __('Title', 'InCloud');
        __('Author', 'InCloud');
        __('Categories', 'InCloud');
        __('Tags', 'InCloud');
        __('Comments', 'InCloud');
        __('Date', 'InCloud');
        __('Show All', 'InCloud');
        __('Show All Authors', 'InCloud');
        __('Thank you for creating with', 'InCloud');
        __('and', 'InCloud');
        __('Settings', 'InCloud');
        __('Manage', 'InCloud');
        __('Select Image', 'InCloud');
        __('Upload File', 'InCloud');
        __('Use This File', 'InCloud');
        __('Select File', 'InCloud');
        __('Remove Value', 'InCloud');
        __('Select All', 'InCloud');
        __('Select None', 'InCloud');
        __('No term found.', 'InCloud');
        __('Select', 'InCloud');
        __('Insert', 'InCloud');
        __('Use This', 'InCloud');
        __('Return to Library', 'InCloud');
        __('%1$s queries in %2$s seconds.', 'InCloud');
        __('%1$s out of %2$s MB (%3$s) memory used.', 'InCloud');
        __('Peak memory usage %1$s MB.', 'InCloud');
        __('Initial memory usage  %1$s MB.', 'InCloud');
        __('The allowed maximum number of fields is {0}.', 'InCloud');
        __('The allowed minimum number of fields is {0}.', 'InCloud');
        __('Add', 'InCloud');
        __('Remove', 'InCloud');
        __('The allowed maximum number of sections is {0}', 'InCloud');
        __('The allowed minimum number of sections is {0}', 'InCloud');
        __('Add Section', 'InCloud');
        __('Remove Section', 'InCloud');
        __('Toggle All', 'InCloud');
        __('Toggle all collapsible sections', 'InCloud');
        __('Reset', 'InCloud');
        __('Yes', 'InCloud');
        __('No', 'InCloud');
        __('On', 'InCloud');
        ...
        __('Enabled', 'InCloud');
        __('Disabled', 'InCloud');
        __('Supported', 'InCloud');
        __('Not Supported', 'InCloud');
        __('Functional', 'InCloud');
        __('Not Functional', 'InCloud');
        __('Too Long', 'InCloud');
        __('Acceptable', 'InCloud');
        __('No log found.', 'InCloud');
        __('The method is called too early: %1$s', 'InCloud');
        __('Debug Info', 'InCloud');
        __('Click here to expand to view the contents.', 'InCloud');
        __('Click here to collapse the contents.', 'InCloud');
        __('Loading...', 'InCloud');
        __('Please enable JavaScript for better user experience.', 'InCloud');
        __('Debug', 'InCloud');
        __('Field Arguments', 'InCloud');
        __('This information will be disabled when <code>WP_DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'InCloud');
        __('Section Arguments', 'InCloud');
        __('The ability to repeat sections is disabled.', 'InCloud');
        __('The ability to repeat fields is disabled.', 'InCloud');
        __('Warning.', 'InCloud');
    }
    }
