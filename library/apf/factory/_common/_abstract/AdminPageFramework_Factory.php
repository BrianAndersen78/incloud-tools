...
abstract class InCloudAdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'InCloudAdminPageFramework_Form_', 'oPageLoadInfo' => 'InCloudAdminPageFramework_PageLoadInfo_', 'oResource' => 'InCloudAdminPageFramework_Resource_', 'oHelpPane' => 'InCloudAdminPageFramework_HelpPane_', 'oLink' => 'InCloudAdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'InCloudAdminPageFramework_Debug', 'oUtil' => 'InCloudAdminPageFramework_FrameworkUtility', 'oMsg' => 'InCloudAdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(InCloudAdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return InCloudAdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
    ...
    abstract class InCloudAdminPageFramework_Factory_Model extends InCloudAdminPageFramework_Factory_Router {
        public function __construct($oProp) {
    ...
    abstract class InCloudAdminPageFramework_Factory_View extends InCloudAdminPageFramework_Factory_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            new InCloudAdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
        }
    ...
    abstract class InCloudAdminPageFramework_Factory_Controller extends InCloudAdminPageFramework_Factory_View {
    ...
    abstract class InCloudAdminPageFramework_Factory extends InCloudAdminPageFramework_Factory_Controller {
    }
