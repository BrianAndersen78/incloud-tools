...
class InCloudAdminPageFramework_AdminNotice extends InCloudAdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'InCloud-settings-notice-message', 'InCloud-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new InCloudAdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
