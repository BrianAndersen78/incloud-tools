...
class InCloudAdminPageFramework_Debug_Base extends InCloudAdminPageFramework_FrameworkUtility {
    ...
    class InCloudAdminPageFramework_Debug_Log extends InCloudAdminPageFramework_Debug_Base {
    ...
    class InCloudAdminPageFramework_Debug extends InCloudAdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('InCloudAdminPageFramework_Debug::' . __FUNCTION__, 'InCloudAdminPageFramework_Debug::dump()');
            InCloudAdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('InCloudAdminPageFramework_Debug::' . __FUNCTION__, 'InCloudAdminPageFramework_Debug::get()');
            return InCloudAdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('InCloudAdminPageFramework_Debug::' . __FUNCTION__, 'InCloudAdminPageFramework_Debug::log()');
            InCloudAdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('InCloudAdminPageFramework_Debug::' . __FUNCTION__);
