...
class InCloudAdminPageFramework_WPUtility_URL extends InCloudAdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(InCloudAdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(InCloudAdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = InCloudAdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
    ...
    class InCloudAdminPageFramework_WPUtility_HTML extends InCloudAdminPageFramework_WPUtility_URL {
    ...
    class InCloudAdminPageFramework_WPUtility_Page extends InCloudAdminPageFramework_WPUtility_HTML {
    ...
    class InCloudAdminPageFramework_WPUtility_Hook extends InCloudAdminPageFramework_WPUtility_Page {
    ...
    class InCloudAdminPageFramework_WPUtility_File extends InCloudAdminPageFramework_WPUtility_Hook {
    ...
    class InCloudAdminPageFramework_WPUtility_Option extends InCloudAdminPageFramework_WPUtility_File {
    ...
    class InCloudAdminPageFramework_WPUtility_Meta extends InCloudAdminPageFramework_WPUtility_Option {
    ...
    class InCloudAdminPageFramework_WPUtility_SiteInformation extends InCloudAdminPageFramework_WPUtility_Meta {
    ...
    class InCloudAdminPageFramework_WPUtility_SystemInformation extends InCloudAdminPageFramework_WPUtility_SiteInformation {
    ...
    class InCloudAdminPageFramework_WPUtility extends InCloudAdminPageFramework_WPUtility_SystemInformation {
