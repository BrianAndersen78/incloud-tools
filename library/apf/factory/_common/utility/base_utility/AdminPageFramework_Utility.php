...
abstract class InCloudAdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        InCloudAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return InCloudAdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        InCloudAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return InCloudAdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        InCloudAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        InCloudAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        InCloudAdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'InCloudAdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class InCloudAdminPageFramework_Utility_VariableType extends InCloudAdminPageFramework_Utility_Deprecated {
    ...
    abstract class InCloudAdminPageFramework_Utility_String extends InCloudAdminPageFramework_Utility_VariableType {
    ...
    abstract class InCloudAdminPageFramework_Utility_Array extends InCloudAdminPageFramework_Utility_String {
    ...
    abstract class InCloudAdminPageFramework_Utility_ArrayGetter extends InCloudAdminPageFramework_Utility_Array {
    ...
    abstract class InCloudAdminPageFramework_Utility_ArraySetter extends InCloudAdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class InCloudAdminPageFramework_Utility_Path extends InCloudAdminPageFramework_Utility_ArraySetter {
    ...
    abstract class InCloudAdminPageFramework_Utility_URL extends InCloudAdminPageFramework_Utility_Path {
    ...
    abstract class InCloudAdminPageFramework_Utility_File extends InCloudAdminPageFramework_Utility_URL {
    ...
    abstract class InCloudAdminPageFramework_Utility_SystemInformation extends InCloudAdminPageFramework_Utility_File {
    ...
    abstract class InCloudAdminPageFramework_Utility_HTMLAttribute extends InCloudAdminPageFramework_Utility_SystemInformation {
    ...
    class InCloudAdminPageFramework_Utility extends InCloudAdminPageFramework_Utility_HTMLAttribute {
